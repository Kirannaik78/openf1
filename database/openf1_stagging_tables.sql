create table if not exists openf1.circuit_stagging(
...
create table if not exists openf1.country_stagging(
...
create table if not exists openf1.meeting_stagging(
...
create table if not exists openf1.sessions_stagging(
...
create table if not exists openf1.drivers_stagging(
